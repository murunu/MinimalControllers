...
//
//     [HttpGet("/{apple}")]
//     public async Task<IActionResult> Test4([FromHeader(Name = "banana")] string header, 
//         [FromBody(EmptyBodyBehavior = Microsoft.AspNetCore.Mvc.ModelBinding.EmptyBodyBehavior.Allow)] string banana,
//         [FromRoute(Name = "apple")] string apple, [FromServices] string lol)
//     {
//         return BadRequest();
//     }
// }